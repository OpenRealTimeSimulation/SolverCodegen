...
#include "codegen/SubsystemSimulationEngineGenerator.hpp"
...
SubsystemSimulationEngineGenerator::SubsystemSimulationEngineGenerator
(
	std::string model_name,
	unsigned int num_solutions
) :
	SimulationEngineGenerator(model_name, num_solutions),
	ports(),
	source_gains(),
	port_source_ids()
{
...
SubsystemSimulationEngineGenerator::SubsystemSimulationEngineGenerator(const SubsystemSimulationEngineGenerator& base) :
	SimulationEngineGenerator(base),
	ports(base.ports),
	source_gains(base.source_gains),
	port_source_ids(base.port_source_ids)
{}

void SubsystemSimulationEngineGenerator::reset(std::string model_name, unsigned int num_solutions)
{
	if(model_name == "")
...
void SubsystemSimulationEngineGenerator::addPort(const Port& port)
{
...
void SubsystemSimulationEngineGenerator::setPorts(const std::vector<Port>& ports)
{
...
const SubsystemSimulationEngineGenerator::Port& SubsystemSimulationEngineGenerator::getPort(unsigned int id) const
{
	for(const auto& p : ports)
	{
		if(p.id == id)
...
std::vector<SubsystemSimulationEngineGenerator::PortModel> SubsystemSimulationEngineGenerator::computePortModels() const
{
	if(ports.empty())
	{
	...
	std::vector<SubsystemSimulationEngineGenerator::PortModel> port_models(num_ports);
...
void SubsystemSimulationEngineGenerator::stampOthersPortModel(const PortModel& port_model)
{
...
void SubsystemSimulationEngineGenerator::stampOthersPortModels(const std::vector<PortModel>& port_models)
{
	try
	{
...
void SubsystemSimulationEngineGenerator::addOwnSourceGains(const PortModel& port_model)
{
	for(const auto& port : ports)
	{
...
void SubsystemSimulationEngineGenerator::addOwnSourceGains(const std::vector<PortModel>& port_models)
{
	for(const auto& port_model : port_models)
	{
...
std::string SubsystemSimulationEngineGenerator::generatePortSourceEquation(unsigned int port_id) const
{
...
std::string SubsystemSimulationEngineGenerator::generatePortSourceEquations() const
{
...
std::string SubsystemSimulationEngineGenerator::generatePortSourceInputParameterList() const
{
...
std::string SubsystemSimulationEngineGenerator::generatePortSourceOutputParameterList() const
{
...
std::string SubsystemSimulationEngineGenerator::generateCFunctionParameterList() const
{
	std::stringstream sstrm;
...
std::string SubsystemSimulationEngineGenerator::generateCInlineCode(double zero_bound) const
{
	std::stringstream sstrm;
	...
	//HERE: rearrange order of the code here for subsystem solving (nodal decomposition) 2020-02-15-20.10
...
std::string SubsystemSimulationEngineGenerator::generateCFunction(double zero_bound) const
{
	std::stringstream sstrm;
...
void SubsystemSimulationEngineGenerator::generateCFunctionAndExport(std::string filename, double zero_bound) const
{
	if(filename == "")
