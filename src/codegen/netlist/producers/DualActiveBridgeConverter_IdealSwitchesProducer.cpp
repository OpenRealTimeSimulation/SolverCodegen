...
DualActiveBridgeConverter_IdealSwitchesProducer::DualActiveBridgeConverter_IdealSwitchesProducer() :
	ComponentProducer()
{
	type = "DualActiveBridgeConverter_IdealSwitches";
	producer_name = "DualActiveBridgeConverter_IdealSwitchesProducer";
	num_parameters = 12;
	num_terminals  = 4;
}

DualActiveBridgeConverter_IdealSwitchesProducer::DualActiveBridgeConverter_IdealSwitchesProducer(const DualActiveBridgeConverter_IdealSwitchesProducer& base) :
...
DualActiveBridgeConverter_IdealSwitchesProducer::DualActiveBridgeConverter_IdealSwitchesProducer(DualActiveBridgeConverter_IdealSwitchesProducer&& base) :
	ComponentProducer(base)
{
...
std::unique_ptr<Component> DualActiveBridgeConverter_IdealSwitchesProducer::operator()(const ComponentListing& component_def) const
{
	assertNetlistComponentInstanceValid(component_def);

	DualActiveBridgeConverter_IdealSwitches* comp = new DualActiveBridgeConverter_IdealSwitches
	(
		...
		component_def.getParameter(9),
		component_def.getParameter(10),
		component_def.getParameter(11)
	);
