...
#ifndef LBLMC_BRIDGECONVERTER_1LEGIDEALSWITCHESANTIPARALLELDIODES_HPP
#define LBLMC_BRIDGECONVERTER_1LEGIDEALSWITCHESANTIPARALLELDIODES_HPP
...
**/
class BridgeConverter_1LegIdealSwitchesAntiParallelDiodes : public Component
{
...
public:
	...
	BridgeConverter_1LegIdealSwitchesAntiParallelDiodes(std::string comp_name);
	BridgeConverter_1LegIdealSwitchesAntiParallelDiodes
	(
	...
	BridgeConverter_1LegIdealSwitchesAntiParallelDiodes(const BridgeConverter_1LegIdealSwitchesAntiParallelDiodes& base);

	inline std::string getType() const { return std::string("BridgeConverter_1LegIdealSwitchesAntiParallelDiodes");}
...
#endif // LBLMC_BRIDGECONVERTER1LEGIDEALSWITCHESANTIPARALLELDIODES_HPP
